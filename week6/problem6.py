...
def main():
    ...
    # fixme: come up with a better phrase than 'Enter a number:' that
    #  will clearly communicate to the use what the number is about
    length_of_word = int(input("Enter a number: "))
    selected_words = list(filter(lambda x: bool(len(x) == length_of_word), common_words))
    print(f"List of {length_of_word} letter words: \n{selected_words}")
